            ...
            <div className="container container--cart">
                <div className="cart">
                    ...
                    <div className="cart__items">
                        <div className="cart__item">
                            <div className="cart__item-img">
                                <img
                                    ...
                                    src="https://i.ibb.co/1vmFwkR/burger-one.png"
                                    alt="Pizza"
                                />
                                </div>
                            ...
                            <div className="cart__item-price"><b>395 &psi;</b></div>
                        ...
                        <div className="cart__item">
                            <div
                                ...
                                <img
                                    className="pizza-block__image"
                                    src="https://i.ibb.co/VD2TPmw/burger-three.png"
                                    alt="Pizza"
                                />
                                </div>
                            ...
                            <div className="cart__item-price"><b>675 &psi;</b></div>
                            <div className="cart__item-remove">
                                <div className="button button--outline button--circle">
                                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="cart__bottom">
                        <div className="cart__bottom-details"><span> Всего: <b>2 шт.</b> </span><span> Сумма заказа: <b>1070 &psi;</b> </span>
                        </div>
